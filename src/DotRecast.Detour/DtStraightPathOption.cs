...
namespace DotRecast.Detour
{
    public class DtStraightPathOption
    {
        ...
        public static readonly DtStraightPathOption AreaCrossings = new(DtNavMeshQuery.DT_STRAIGHTPATH_AREA_CROSSINGS, "Area");
        public static readonly DtStraightPathOption AllCrossings = new(DtNavMeshQuery.DT_STRAIGHTPATH_ALL_CROSSINGS, "All");
