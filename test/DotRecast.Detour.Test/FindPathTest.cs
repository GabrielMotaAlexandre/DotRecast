...
public class FindPathTest : AbstractDetourTest
{
    ...
    private static readonly StraightPathItem[][] STRAIGHT_PATHS =
    {
        new[]
        {
            ...
            new StraightPathItem(new Vector3(3.484785f, 10.197294f, -34.241272f), 0, 281474976710713L),
            new StraightPathItem(new Vector3(1.984785f, 10.197294f, -31.241272f), 0, 281474976710712L),
            new StraightPathItem(new Vector3(1.984785f, 10.197294f, -29.741272f), 0, 281474976710727L),
            new StraightPathItem(new Vector3(2.584784f, 10.197294f, -27.941273f), 0, 281474976710730L),
            new StraightPathItem(new Vector3(6.457663f, 10.197294f, -18.334061f), 2, 0L)
        },

        new[]
        {
            new StraightPathItem(new Vector3(22.331268f, 10.197294f, -1.040187f), 1, 281474976710773L),
            new StraightPathItem(new Vector3(9.784786f, 10.197294f, -2.141273f), 0, 281474976710755L),
            new StraightPathItem(new Vector3(7.984783f, 10.197294f, -2.441269f), 0, 281474976710753L),
            new StraightPathItem(new Vector3(1.984785f, 10.197294f, -8.441269f), 0, 281474976710752L),
            new StraightPathItem(new Vector3(-4.315216f, 10.197294f, -15.341270f), 0, 281474976710724L),
            new StraightPathItem(new Vector3(-8.215216f, 10.197294f, -17.441269f), 0, 281474976710728L),
            new StraightPathItem(new Vector3(-10.015216f, 10.197294f, -17.741272f), 0, 281474976710738L),
            new StraightPathItem(new Vector3(-11.815216f, 9.997294f, -17.441269f), 0, 281474976710736L),
            new StraightPathItem(new Vector3(-17.815216f, 5.197294f, -11.441269f), 0, 281474976710735L),
            new StraightPathItem(new Vector3(-17.815216f, 5.197294f, -8.441269f), 0, 281474976710746L),
            new StraightPathItem(new Vector3(-11.815216f, 0.197294f, 3.008419f), 2, 0L)
        },

        new[]
        {
            new StraightPathItem(new Vector3(18.694363f, 15.803535f, -73.090416f), 1, 281474976710680L),
            new StraightPathItem(new Vector3(17.584785f, 10.197294f, -49.841274f), 0, 281474976710697L),
            new StraightPathItem(new Vector3(17.284786f, 10.197294f, -48.041275f), 0, 281474976710695L),
            new StraightPathItem(new Vector3(16.084785f, 10.197294f, -45.341274f), 0, 281474976710694L),
            new StraightPathItem(new Vector3(3.484785f, 10.197294f, -34.241272f), 0, 281474976710713L),
            new StraightPathItem(new Vector3(1.984785f, 10.197294f, -31.241272f), 0, 281474976710712L),
            new StraightPathItem(new Vector3(1.984785f, 10.197294f, -8.441269f), 0, 281474976710753L),
            new StraightPathItem(new Vector3(7.984783f, 10.197294f, -2.441269f), 0, 281474976710755L),
            new StraightPathItem(new Vector3(9.784786f, 10.197294f, -2.141273f), 0, 281474976710768L),
            new StraightPathItem(new Vector3(38.423977f, 10.197294f, -0.116067f), 2, 0L)
        },

        new[]
        {
            new StraightPathItem(new Vector3(0.745335f, 10.197294f, -5.940050f), 1, 281474976710753L),
            new StraightPathItem(new Vector3(0.863553f, 10.197294f, -10.310320f), 2, 0L)
        },

        new[]
        {
            new StraightPathItem(new Vector3(-20.651257f, 5.904126f, -13.712508f), 1, 281474976710733L),
            new StraightPathItem(new Vector3(-11.815216f, 9.997294f, -17.441269f), 0, 281474976710738L),
            new StraightPathItem(new Vector3(-10.015216f, 10.197294f, -17.741272f), 0, 281474976710728L),
            new StraightPathItem(new Vector3(-8.215216f, 10.197294f, -17.441269f), 0, 281474976710724L),
            new StraightPathItem(new Vector3(-4.315216f, 10.197294f, -15.341270f), 0, 281474976710729L),
            new StraightPathItem(new Vector3(1.984785f, 10.197294f, -8.441269f), 0, 281474976710753L),
            new StraightPathItem(new Vector3(7.984783f, 10.197294f, -2.441269f), 0, 281474976710755L),
            new StraightPathItem(new Vector3(18.784092f, 10.197294f, 3.054368f), 2, 0L)
        }
    };
